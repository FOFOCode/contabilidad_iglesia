...
import { login, hayUsuariosRegistrados, crearPrimerAdmin } from "@/app/actions/auth";
...
export default function LoginPage() {
  ...
  const handleCrearAdmin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const result = await crearPrimerAdmin({ nombre, apellido, correo, contrasena });
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#eef4f7] to-[#d9e8ef] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#203b46]">Sistema Contable</h1>
          <p className="text-[#40768c] mt-1">Iglesia - Administración Interna</p>
        </div>
          ...
          <Card className="shadow-xl">
            <div className="mb-6">
              <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm mb-4">
                <strong>¡Bienvenido!</strong> No hay usuarios registrados. Cree el primer usuario administrador para comenzar.
              </div>
            </div>
